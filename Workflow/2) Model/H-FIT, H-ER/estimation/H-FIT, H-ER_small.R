...
# load the full data
Data<-load("Data/reduced_Data.RData")
...
for (tau in 1:length(t)){
  ...
  X_hat_ER[[tau]]<-Lsamp2
  save(Lsamp1,file=paste("2) Model/H-FIT, H-ER/results/small_fit_",t[tau],".RData",sep=""))
  save(Lsamp2,file=paste("2) Model/H-FIT, H-ER/results/small_ER_",t[tau],".RData",sep=""))
...
save.image("2) Model/H-FIT, H-ER/results/hierarch_small.RData")
